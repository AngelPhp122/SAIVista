...
namespace SAIModelo
{
    internal class ReportesModel
    {
        ...
        private string[,] datosReporteVentas(string fechaInicio, string fechaHasta)
        {
            try
            {
                string[,] arregloDatos;
        ...
        public string[,] getDatosReporteVentas(string fechaInicio, string fechaHasta)
        {

            string[,] arregloDatos;

            arregloDatos = datosReporteVentas(fechaInicio, fechaHasta);
